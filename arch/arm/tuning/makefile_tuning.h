...
KBUILD_CFLAGS  += $(call cc-option,-mfloat-abi=hard,-mhard-float)
...
KBUILD_AFLAGS  += $(call cc-option,-Wa$(comma)-mfloat-abi=hard)
KBUILD_AFLAGS  += $(call cc-option,-Wa$(comma)-mfpu=vfpv3-d16)

tune-y         := $(call cc-option,-mcpu=cortex-a9)
tune-y         += $(call cc-option,-mtune=cortex-a9)
tune-y         += $(call cc-option,-mfpu=vfpv3-d16)
tune-y         += $(call cc-option,-Wa$(comma)-march=armv7-a)
tune-y         += $(call cc-option,-Wa$(comma)-mcpu=cortex-a9)
